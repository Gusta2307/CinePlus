    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(
             opts => opts.UseSqlite("Data Source=booking.db", x => x.MigrationsHistoryTable("Booking._EFMigrationHistory")));
            ...
            //EventHandlers
            services.AddMediatR(Assembly.Load("BookingServiceEventHandler"));
